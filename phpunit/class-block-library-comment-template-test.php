...
class Block_Library_Comment_Template_Test extends WP_UnitTestCase {
	...
	function test_rendering_comment_template() {
		...
		// in the build step.
		$this->assertEquals(
			'<ol ><li id="comment-'.self::$comment_ids[0].'"><div class="has-small-font-size wp-block-comment-author-name"><a rel="external nofollow ugc" href="http://example.com/author-url/" target="_self" >Test</a></div><div class="wp-block-comment-content">Hello world</div></li></ol>',
	...
	function test_rendering_comment_template_nested() {
		...
		$this->assertEquals(
			gutenberg_render_block_core_comment_template( null, null, $block ),
			'<ol ><li id="comment-'.self::$comment_ids[0].'"><div class="has-small-font-size wp-block-comment-author-name"><a rel="external nofollow ugc" href="http://example.com/author-url/" target="_self" >Test</a></div><div class="wp-block-comment-content">Hello world</div><ol><li id="comment-'.$first_level_ids[0].'"><div class="has-small-font-size wp-block-comment-author-name"><a rel="external nofollow ugc" href="http://example.com/author-url/" target="_self" >Test</a></div><div class="wp-block-comment-content">Hello world</div><ol><li id="comment-'.$second_level_ids[0].'"><div class="has-small-font-size wp-block-comment-author-name"><a rel="external nofollow ugc" href="http://example.com/author-url/" target="_self" >Test</a></div><div class="wp-block-comment-content">Hello world</div></li></ol></li></ol></li></ol>'
		);
	}
	/**
